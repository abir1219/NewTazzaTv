...
class CategoryWiseSportsArticles extends StatefulWidget {
  final categoryName;
  const CategoryWiseSportsArticles({Key? key, required this.categoryName})
      : super(key: key);

  @override
  State<CategoryWiseSportsArticles> createState() =>
      _CategoryWiseSportsArticlesState();
}

class _CategoryWiseSportsArticlesState
    extends State<CategoryWiseSportsArticles> {
  @override
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) => NewsDetails(
                                            newsId: value
                                                .categoryWiseSportsArticlesModel!
                                                .list![index]
                                                .id
                                                .toString(),
                                          ),
                              ...
                              itemCount: value
                                  .categoryWiseSportsArticlesModel!.list!.length),
                        )
                      ],
                    ),
                  ))
