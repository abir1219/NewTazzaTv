                              ...
                              Consumer<DataProvider>(
                                builder: (context, value, child) {
                                  return ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount: value
                                        .stateFourthTopNewsModel!.list!.length,
                                    itemBuilder: (context, index) {
                                      return InkWell(
                                        onTap: () {
                                          Navigator.push(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: ListView.builder(
                                        //physics: const NeverScrollableScrollPhysics(),
                                          ...
                                          itemCount: value.topNationalNewsModel!
                                              .list!.length),
                                    ),
                                  );
                                },
                                ...
                                builder: (context, value, child) {
                                  return GridView.builder(
                                    ...
                                    const SliverGridDelegateWithFixedCrossAxisCount(
                                        ...
                                        mainAxisSpacing: 2.0),
                                    itemCount: value
                                        .cateforyWiseSportsModel!.list!.length,
                                    itemBuilder: (context, index) {
                                      return InkWell(
                                        onTap: () {
                                          Navigator.push(
